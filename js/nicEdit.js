...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split('/')[0] + '/js/nicEditorIcons.gif',
...
var nicEditorPane = bkClass.extend({
	construct : function(elm,nicEditor,options,openButton) {
		...
		this.pos[1] = Math.round(offset) + 80;
		this.contain = new bkElement('div').setStyle({ zIndex: '999999', overflow: 'hidden', position: 'absolute', left : this.pos[0]+'px', top : this.pos[1]+'px'})
